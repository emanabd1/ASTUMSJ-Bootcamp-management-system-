...
        <div className="flex h-10 w-10 items-center justify-center rounded-full border-2 border-[#c89b7b] bg-white overflow-hidden">
          <img src="/logo.png" alt="Logo" className="h-full w-full object-cover" />
        </div>
        <div>
          <h2 className="text-sm font-extrabold tracking-tight">Portal Menu</h2>
          <p className="text-[10px] text-[#a39081] uppercase">{role} Control Panel</p>
        </div>
      </div>
