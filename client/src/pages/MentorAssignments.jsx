...
export default function MentorAssignments() {
  // Students should eventually come from your Admin assignment system.
  // For now, this reads them from localStorage.
  const [students] = useState(() => {
    const saved = localStorage.getItem("assignedStudents");
    ...
    const updatedAssignments = assignments.map(
      (assignment) => {
        ...
        return {
          ...
          students: assignment.students.map(
            (student) => {
              if (
                student.id !==
                grading.studentId
          ...
          <div className="w-full max-w-xl rounded-xl border border-[#4a3528] bg-[#1d1511]">
            ...
            >
              ...
              <input
                ...
                className="w-full rounded-lg border border-[#4a3528] bg-[#120d0a] p-3"
              />
          ...
          <div className="w-full max-w-lg rounded-xl border border-[#4a3528] bg-[#1d1511]">
            ...
            >
              ...
              <div className="flex justify-end gap-3">
                ...
                <button
                  type="submit"
                  className="rounded-lg bg-green-700 px-5 py-3 font-bold"
                >
                  Save Grade
                </button>
